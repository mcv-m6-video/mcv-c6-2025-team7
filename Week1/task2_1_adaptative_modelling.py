...
from utils import adaptive_segment_foreground, estimate_background, visualize_estimated_background
...
def adaptative_modelling(
    ...
    output_folder = Path("Output_Videos") / "AdaptativeModelling"
...
if __name__ == "__main__":
    ...
    adaptative_modelling(video_path.as_posix(),
                         percent=0.25,
                         alpha=2.5,
                         rho=0.01,
                         use_median=False,
                         output_name="task_2_1_mean_alpha2.5_rho0.01",
                         show_video=False)
