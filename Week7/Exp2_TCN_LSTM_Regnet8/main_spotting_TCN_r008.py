...
from model.model_spotting_TCN_r008 import Model
import wandb
import optuna
    ...
    if not args.only_test:
        ...
        for epoch in range(epoch, num_epochs):
            ...
            if args.save_dir is not None:
                ...
                if better:
                    torch.save( model.state_dict(), os.path.join(ckpt_dir, f'TCN_r8{args.batch_size}_{args.learning_rate}_{args.num_epochs}_{args.downsample_factor}_{args.warm_up_epochs}.pt') )
    
    # model_parameters = model.get_model_parameters()
    # wandb.log({"model_params": model_parameters})

    print('START INFERENCE')
    model.load(torch.load(os.path.join(ckpt_dir, f'TCN_r8{args.batch_size}_{args.learning_rate}_{args.num_epochs}_{args.downsample_factor}_{args.warm_up_epochs}.pt')))
