...
def run_training(args, trial):
    ...
    wandb.init(
        project='Week6_NetVLADpp_NoTempDist',
        entity='mcv-c6g7',
        name=execution_name,
    ...
    with open(f"results/results_netvladpp_baseline_no_temp_dist.txt", "w") as f:
        f.write(result_text)
    ...
    with open(f"summary/model_summary_netvladpp_no_temp_dist.txt", "w") as f:
        f.write(summary_str)
